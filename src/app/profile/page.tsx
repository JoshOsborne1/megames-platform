...
export default function ProfilePage() {
  ...
  // Not logged in - show integrated auth forms
  if (!user) {
    return (
      <AppShell>
        <div className="min-h-screen px-4 py-8 max-w-md mx-auto flex flex-col justify-center">
          <motion.div
            ...
            className="widget-card !p-8 relative overflow-hidden backdrop-blur-xl bg-[#0a0015]/60 border-white/10"
          >
            {/* Glow effects */}
            <div className="absolute -top-20 -right-20 w-40 h-40 bg-[#ff006e]/20 blur-3xl rounded-full" />
            <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-[#8338ec]/20 blur-3xl rounded-full" />

            <div className="relative z-10 space-y-6">
              <div className="text-center space-y-2">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-[#ff006e] to-[#8338ec] mx-auto flex items-center justify-center shadow-lg shadow-purple-500/20 mb-4">
                ...
                <p className="text-white/50 text-sm">
                  {authMode === "login"
                    ...
                    : "Create an account to track stats"}
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button
                  ...
                  className="h-10 border-white/10 hover:bg-white/5 text-white bg-transparent"
                >
                ...
                <Button
                  ...
                  className="h-10 border-white/10 hover:bg-[#5865F2]/20 text-white bg-transparent hover:border-[#5865F2]"
                >
                  <svg className="w-4 h-4 mr-2" viewBox="0 0 127.14 96.36"><path fill="currentColor" d="M107.7,8.07A105.15,105.15,0,0,0,81.47,0a72.06,72.06,0,0,0-3.36,6.83A97.68,97.68,0,0,0,49,6.83,72.37,72.37,0,0,0,45.64,0,105.89,105.89,0,0,0,19.39,8.09C2.79,32.65-1.71,56.6.54,80.21h0A105.73,105.73,0,0,0,32.71,96.36,77.11,77.11,0,0,0,39.6,85.25a68.42,68.42,0,0,1-10.85-5.18c.91-.66,1.8-1.34,2.66-2a75.57,75.57,0,0,0,64.32,0c.87.71,1.76,1.39,2.66,2a68.68,68.68,0,0,1-10.87,5.19,77,77,0,0,0,6.89,11.1A105.89,105.89,0,0,0,126.6,80.22c1.24-18.87-3.37-43.27-18.9-72.15ZM42.45,65.69C36.18,65.69,31,60,31,53s5-12.74,11.43-12.74S54,46,53.89,53,48.84,65.69,42.45,65.69Zm42.24,0C78.41,65.69,73.25,60,73.25,53s5-12.74,11.44-12.74S96.23,46,96.12,53,91.08,65.69,84.69,65.69Z" /></svg>
                  Discord
                </Button>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-[#0f0a1e] px-2 text-white/40">Or continue with</span>
                </div>
              </div>
              ...
              <form onSubmit={handleAuth} className="space-y-4">
                {authMode === "signup" && (
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <User className="absolute left-3 top-3 w-5 h-5 text-white/30 group-focus-within:text-[#00f5ff] transition-colors" />
                      <Input
                        type="text"
                        placeholder="PlayerOne"
                        value={username}
                        onChange={(e) => setUsername(e.target.value)}
                        className="pl-10 h-10 bg-white/5 border-white/10 focus:border-[#00f5ff]/50 focus:ring-[#00f5ff]/20"
                        required
                      />
                    </div>
                  </div>
                ...
                <Button
                  ...
                  className="w-full h-11 bg-gradient-to-r from-[#00f5ff] to-[#8338ec] hover:from-[#00f5ff]/90 hover:to-[#8338ec]/90 text-white font-bold"
                >
                  {authLoading ? (
              ...
              <div className="text-center text-sm">
                ...
                <button
                  ...
                  className="text-[#00f5ff] font-bold hover:underline"
                >
