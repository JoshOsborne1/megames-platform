      ...
      <div className="flex flex-col justify-center p-4 md:p-12 lg:p-16 relative">
        ...
        <div className="w-full max-w-md mx-auto space-y-8">
          <div className="text-center lg:text-left space-y-2">
            ...
            <h1 className="font-display text-4xl font-bold text-white">Join PartyPack</h1>
            <p className="text-white/50 text-lg">Create an account to start playing.</p>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <User className="absolute left-3 top-3 w-5 h-5 text-white/30 group-focus-within:text-[#ff006e] transition-colors" />
                <Input
                  id="username"
                  type="text"
                  ...
                  className="pl-10 h-12 bg-white/5 border-white/10 focus:border-[#ff006e]/50 focus:ring-[#ff006e]/20"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <Mail className="absolute left-3 top-3 w-5 h-5 text-white/30 group-focus-within:text-[#ff006e] transition-colors" />
                <Input
                  id="email"
                  type="email"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <Lock className="absolute left-3 top-3 w-5 h-5 text-white/30 group-focus-within:text-[#ff006e] transition-colors" />
                <Input
                  id="password"
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-gradient-to-r from-[#ff006e] to-[#ff006e] hover:from-[#ff006e]/80 hover:to-[#ff006e]/80 text-white font-bold text-lg"
            >
          ...
          <p className="text-center text-white/40">
            ...
            <Link href="/login" className="text-[#ff006e] hover:underline font-bold">
              Sign in
            </Link>
          </p>
        </div>
