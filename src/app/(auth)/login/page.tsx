      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-8 lg:py-0 relative z-10">
        ...
        >
          ...
          <Link href="/" className="flex flex-col items-center mt-4 mb-4 lg:mt-0 lg:mb-6">
            ...
            >
              <Image
                ...
                width={48}
                height={60}
                className="w-12 lg:w-14 h-auto drop-shadow-[0_0_20px_rgba(0,245,255,0.3)]"
              />
            </motion.div>
          ...
          >
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  className="pl-9 h-11 bg-white/5 border-white/10 focus:border-[#00f5ff]/50 focus:ring-[#00f5ff]/20 focus:bg-white/[0.07] transition-all placeholder:text-white/25 text-sm"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                <Link href="/forgot-password" className="text-[10px] text-[#00f5ff]/80 hover:text-[#00f5ff] transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative group">
                ...
                <Input
                  ...
                  className="pl-9 pr-9 h-11 bg-white/5 border-white/10 focus:border-[#00f5ff]/50 focus:ring-[#00f5ff]/20 focus:bg-white/[0.07] transition-all placeholder:text-white/25 text-sm"
                  required
                />
                <button
                  type="button"
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-11 bg-gradient-to-r from-[#00f5ff] to-[#00d4e0] hover:from-[#00f5ff]/90 hover:to-[#00d4e0]/90 text-black font-bold text-sm shadow-lg shadow-[#00f5ff]/20 transition-all duration-200"
            >
          ...
          >
            ...
            <Link href="/signup" className="text-[#00f5ff] hover:text-[#00f5ff]/80 font-semibold transition-colors">
              Sign up
            </Link>
          </motion.p>
        </motion.div>
