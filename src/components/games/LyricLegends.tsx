...
import { Trophy, Play, RotateCcw, SkipForward, Check, Mic2, Star } from "lucide-react";
import { LYRIC_WORDS } from "@/lib/games/lyric-legends/data";
import { GameLobby, PlayerManager, createInitialPlayers, InGameNav, type Player as SharedPlayer } from "./shared";
        ...
        {gameState === "countdown" && (
          ...
          >
            <motion.div
              ...
              className="text-[12rem] font-black italic text-gradient-neon leading-none"
              style={{ lineHeight: 1 }}
            >
